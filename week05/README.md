...
<img width="1354" height="564" alt="image" src="https://github.com/user-attachments/assets/98df4b7e-45b3-4633-8810-b11d703c61f4" />
...
2. URL 欄位輸入：
```
    https://api.open-meteo.com/v1/forecast?latitude=24&longitude=121&hourly=temperature_2m,wind_speed_10m
```

3. 點擊「**Send**」
4. 觀察 Response 區域出現的 JSON 資料
...
<img width="1355" height="797" alt="image" src="https://github.com/user-attachments/assets/d37f7b10-b418-4c4c-859d-2a1d166730fd" />
...
<img width="1349" height="782" alt="image" src="https://github.com/user-attachments/assets/f382a574-28f4-41b2-b19d-023408071eea" />
...
<img width="1338" height="869" alt="image" src="https://github.com/user-attachments/assets/1ac4afd3-7d44-4d02-a714-4a4585ad68ae" />
...
<img width="945" height="746" alt="image" src="https://github.com/user-attachments/assets/143dd8ed-5451-4131-bc3e-92183410489c" />
...
1. 你把 API Key 打錯了 : **401 Unauthorized**
2. 你要查詢的使用者 ID 不存在 : **404 Not Found**
3. 你的 Make 劇本在 1 分鐘內呼叫 API 超過 100 次 : **429 Too Many Requests**
